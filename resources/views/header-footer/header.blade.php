<header>
    ...
    <div class="navbar-list absolute flex justify-center items-center z-20">
        <ul class="box-list">
            ...
            <li>
                <a href="{{route('login')}}" class="relative mt-4 flex items-center justify-center text-sky_blue_color bg-white border-2 border-sky_blue_color py-3 space-x-3 rounded-full overflow-hidden group">
