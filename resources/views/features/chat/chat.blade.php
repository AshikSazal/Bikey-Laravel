    ...
    <div id="chat-system">
        <div class="flex items-center justify-center">
            <ul class="flex items-center flex-col" id="chat-list">
                <li class="cursor-pointer mb-2">
                    <div class="bg-[#49e670] rounded-full p-2"><svg fill="#fff" height="30px" width="30px"
                ...
                <li class="cursor-pointer mb-2">
                    <div class="bg-[#1e88e5] rounded-full p-2"><svg fill="#fff" height="30px" width="30px"
                ...
                <li class="cursor-pointer mb-2">
                    <div class="bg-[#3eb9a9] rounded-full p-2"><svg id="direct-message" fill="#fff" height="30px"
                            width="30px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path
        ...
        <div class="" id="showChatProcess">
            <button class="p-2 bg-orange_color rounded-md">
                ...
                <svg id="cross-icon" fill="#fff" xmlns="http://www.w3.org/2000/svg" height="35px" width="35px"
                    viewBox="0 0 384 512">
                    <path
