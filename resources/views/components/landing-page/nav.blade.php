...
@elseif ($flag==2)
    <a href="{{ $href }}" class="relative flex items-center justify-center text-white bg-nav_color border-2 border-nav_color px-8 py-3 rounded-full overflow-hidden group">
        <span class="absolute inset-0 group-hover:bg-white transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 ease-in-out origin-center"></span>
