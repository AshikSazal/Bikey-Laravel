<div id="pop-up" class="hidden fixed top-0 left-0 w-full h-full bg-black bg-opacity-80 justify-center items-center z-20">
    <div class="bg-white rounded-lg w-[400px] min-h-60 px-4 pt-4 pb-6">
        <div class="flex justify-between px-4 pt-2">
            <h1 class="text-2xl text-orange_color">Error</h1>
        ...
        <div class="px-8">
            ...
            <h3 id="show-error-message" class="text-black text-justify"></h3>
        </div>
    </div>
</div>
